...
namespace HospitalMgtSystem.Controllers
{
    public class NursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NurseId,NurseName,Gender,Mobile,JoiningDate")] Nurse nurse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NurseId,NurseName,Gender,Mobile,JoiningDate")] Nurse nurse)
        {
            if (ModelState.IsValid)
            {
